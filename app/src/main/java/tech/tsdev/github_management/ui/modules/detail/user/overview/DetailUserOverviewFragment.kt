package tech.tsdev.github_management.ui.modules.detail.user.overview
...
import tech.tsdev.github_management.ui.modules.detail.user.overview.presenter.DetailUserOverviewContract
import tech.tsdev.github_management.ui.modules.detail.user.overview.presenter.DetailUserOverviewPresenter
...
class DetailUserOverviewFragment : Fragment(), DetailUserOverviewContract.View {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.getString("fragmentUserName")?.let { detailUserOverviewPresneter.loadUserOverView(it) }
    }
}